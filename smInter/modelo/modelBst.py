...
class trieNo(object):
    ...
    def motifBySize(self, listIndxsCons, listStrsCons, minSize, txConser):
        ...
        for grp in range(len(listStrsCons)):
            ...
            for beg in range(len(listStrsCons[grp][0])):
                ...
                for end in range(len(listStrsCons[grp][0]),beg+minSize-1,-1):
                    ...
                    #get the occurrence's of the most frequent subsequence
                    lgsSub=0
        ...
        lstLocFinal, lstMotFinal, lstOccFinal, lstSuppFinal = [], [], [], []
        ...
        print('Motifs idx ::::::::::::', lstLocFinal, lstMotFinal, lstOccFinal)

        return lstMotFinal,lstLocFinal, lstOccFinal, lstSuppFinal
...
root.motifBySize(indices, conservados, 2, 50)
root.processBySize()
